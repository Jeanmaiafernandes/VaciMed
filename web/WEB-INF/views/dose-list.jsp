            ...
            <% if (!doses.isEmpty()) { %>
                <table class="table">
                    ...
                    <tbody>
                        <% for (Dose dose : doses) { %>
                            <tr>
                                <td><strong><%= dose.getNomePaciente() != null ? dose.getNomePaciente() : "N/A" %></strong></td>
                                <td><%= dose.getNomeVacina() != null ? dose.getNomeVacina() : "N/A" %></td>
                                ...
                                <td>
                                    <span class="status-badge status-aplicada">
                                        <%= dose.getStatus() != null ? dose.getStatus() : "Aplicada" %>
                                    </span>
                                </td>
